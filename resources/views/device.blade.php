                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="" id="" class="form-control">
                                    ...
                                    <option value="">Hoạt động</option>
                                    <option value="">Ngừng hoạt động</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="" id="" class="form-control">
                                    <option value="">Tất cả</option>
                                    <option value="">Kết nối</option>
                                    <option value="">Mất kết nối</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3 search">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Nhập từ khóa">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="">
                                                ...
                                                <td class="text-center"><i class='bx bxs-circle text-success'></i> Đang
                                                    kết nối</td>
                                                @else
                                                <td class="text-center"><i class='bx bxs-circle text-danger'></i> Mất kết nối</td>
                                                @endif
                                                <td class="text-center">{{$item->device_title}}</td>
                                                <td class="text-center"><a class="text-info" href="/chi-tiet/{{$item->id}}">Chi tiết</a></td>
                                                <td class="text-center"><a class="text-info" href="/chinh-sua-thiet-bi/{{$item->id}}">Cập nhật</a></td>
                                            </tr>
                                            @endforeach
